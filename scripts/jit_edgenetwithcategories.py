...
from models import EdgeNetWithCategoriesJittable
nonjit_model = EdgeNetWithCategoriesJittable(n_iters=6, input_dim=5, hidden_dim=64)
model = torch.jit.script(nonjit_model)

weights_file = '../saved_weights/models/model_checkpoint_EdgeNetWithCategories_264403_5b5c05404f_csharma.best.pth.tar'
